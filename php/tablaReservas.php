        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <label>Número de habitaciones:</label>
                    <input type="number" class="form-control" name="numero_habitaciones" id="numero_habitaciones">
                </div>
                <div class="col-md-6">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo " 		<td> <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal' onClick='traerData(".$row['id'].",".$row['numeroDocumento'].")'>
                        <i class='bi bi-pencil'></i>
                      </button></td>";
                      echo " 		<td> <button type='button' class='btn btn-danger' onClick='eliminarReserva(".$row['id'].",".$row['numeroDocumento'].")'>
